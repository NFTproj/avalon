...
export default function TokenizationSteps() {
  ...
  return (
    <section className="bg-black text-white py-6 px-4 md:px-16 text-center">
      <div className="w-full flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-4 w-full mb-10 md:mb-20">
          {steps.map((step) => (
            <section
              key={step.step}
              className="mx-0 md:mx-4 px-4 py-8 rounded-lg shadow-lg w-full md:w-[30%] flex items-center justify-center"
              style={{
